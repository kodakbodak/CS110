...
public class ManipulateImage {
    ...
    public static void printImageInfo(BufferedImage buff, String imageFilename) {
      ...
      System.out.println("The image " + imageFilename + " has a type of " + imageHeight + ".");
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Stop program if user supplies "q"                      
            ...
            if (action.equals("v")) {
                ...
                // Use the invertImage method to invert the image using outputImage to store it
                ...
                outputImage = blackoutWhiteoutImage(inputImage, action);
                ...
                // Invoke the method printImageInfo, and pass inputImage and fileName to the method
