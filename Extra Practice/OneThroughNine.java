...
case 1:
System.out.print("1 can be written as 1*1, thus it has 2 factors, but
they are not different hence it is not a prime number.");
break;
case 2:
System.out.print("2 is the only even prime number and it is the
...
break;
case 6:
System.out.print("6 is the smallest numbers that is equal to the sum of
its proper divisors! Interesting!");
break;
